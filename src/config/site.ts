...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "What the models don't want you to know." },
...
export const siteConfig: SiteConfig = {
  domain: "jailbreaks.fyi",
  url: "https://jailbreaks.fyi",
  title: "Jailbreaks FYI",
  tagline: "Working LLM jailbreak techniques, sourced and dated.",
  description:
  ...
  byline: "Jailbreaks FYI Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 340, cluster: "offensive" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@jailbreaks.fyi",
    abuse: "abuse@jailbreaks.fyi",
    editor: "editor@jailbreaks.fyi",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "jailbreaks.fyi"),
  analytics: {},
};
